...
// Con algo de ayuda
// 
// ©Guillermo 'guille' Som, 2004, 2007, 2018-2023
// ------------------------------------------------------------------------------
using System;
...
namespace elGuille.Util.Developer
{
    ...
    {
        /// <summary>
        /// El lenguaje usado para crear la clase.
        /// </summary>
        public static Lenguajes Lang { get; set; }
        // las comprobaciones se harán sin tener en cuenta mayúsculas/minúsculas
        private static readonly string[] tiposVB = new[] { "", "short", "integer", "long", "string", "object", "double", "single", "date", "decimal", "boolean", "byte", "char" };
        private static readonly string[] tiposCS = new[] { "var", "short", "int", "long", "string", "object", "double", "float", "DateTime", "decimal", "bool", "byte", "char" };
        private static readonly string[] modificadoresVB = new[] { "public", "private", "friend", "protected", "shared", "overrides", "overridable", "shadows" };
        private static readonly string[] modificadoresCS = new[] { "public", "private", "internal", "protected", "static", "override", "virtual", "new" };
        private static readonly string[] compVB = new[] { "=", "<>" };
        private static readonly string[] compCS = new[] { "==", "!=" };
        ...
        private static readonly string[] instrVB = new[] { "CBool", "CByte", "CChar", "CDate", "CDbl", "CDec", "CInt", "CLng", "CObj", "CSByte", "CShort", "CSng", "CStr", "CUInt", "CULng", "CUShort", "OrElse", "AndAlso", "Or", "And", "IsNot", "Is", "Nothing", "Not", ".Rows(0)", "New ", ", Me", " Me.", " Me(", " Me,", "(Me,", "True", "False", " & ", "\" \""};
        private static readonly string[] instrCS = new[] { "Convert.ToBoolean", "Convert.ToByte", "Convert.ToChar", "Convert.ToDateTime", "Convert.ToDouble", "Convert.ToDecimal", "Convert.ToInt32", "Convert.ToInt64", "", "Convert.ToSByte", "Convert.ToInt16", "Convert.ToSingle", "Convert.ToString", "Convert.ToUInt32", "Convert.ToUint64", "Convert.ToUint16", " || ", " && ", " | ", " & ", " != ", " == ", " null ", " ! ", ".Rows[0]", "new ", ", this", " this.", " this(", " this,", "(this,", "true", "false", " + ", "' '" };
        ...
        /// <summary>
        /// Asigna un valor new a una variable.
        /// </summary>
        /// <param name="var"></param>
        /// <param name="valor"></param>
        ...
        /// <summary>
        /// Asigna un valor new a una variable con parámetros.
        /// </summary>
        /// <param name="var"></param>
        /// <param name="valor"></param>
